...
script_path <- paste0(path_to_repo,'scripts_final/scripts_Aug2025_to_push/')
...
dir.create(paste0(tables_path, 'Supplementary data'))
write.csv(df_rem_combined, paste0(tables_path, 'Source data/Source data 1'))
