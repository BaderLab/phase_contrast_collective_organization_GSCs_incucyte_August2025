...
dataset_path <- paste0(path_to_repo, 'datasets_final/manuscript_analysis_data/cellprofiler_output/') 
script_path <- paste0(path_to_repo,'/scripts_final/')

save_dir_path <- paste0(path_to_repo, '/out/script01_output_files')
...
### source data 
### source data includes color variables, feature names that were used to rename cellprofiler generated labels and several functions
...
### Combine all datasets and delte individual datasets
```{r}
