...
###------------------------------------------------------------------####
```{r}
source(paste0(script_path,"scripts_Aug2025_to_push/code/source_scripts/sourceData_General_variables_and_functions.R"))
...
for (i in 1:9){
  ...
  sc[[i]] <- PCAtools::screeplot(p, colBar='darkblue', axisLabSize = 27, components = 1:(pc1+1), title = '')
